...
func (a *Client) ListAlertableEventType(params *ListAlertableEventTypeParams, authInfo runtime.ClientAuthInfoWriter) (*ListAlertableEventTypeOK, error) {
	...
	if params == nil {
		params = NewListAlertableEventTypeParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listAlertableEventType",
		Method:             "GET",
		PathPattern:        "/alertableEventTypes",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListAlertableEventTypeReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListAlertableEventTypeOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listAlertableEventType: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
