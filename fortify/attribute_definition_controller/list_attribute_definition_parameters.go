...
// NewListAttributeDefinitionParams creates a new ListAttributeDefinitionParams object
...
func NewListAttributeDefinitionParams() *ListAttributeDefinitionParams {
	...
	return &ListAttributeDefinitionParams{
		Limit: &limitDefault,
		Start: &startDefault,
...
// NewListAttributeDefinitionParamsWithTimeout creates a new ListAttributeDefinitionParams object
...
// NewListAttributeDefinitionParamsWithContext creates a new ListAttributeDefinitionParams object
...
// NewListAttributeDefinitionParamsWithHTTPClient creates a new ListAttributeDefinitionParams object
...
/*ListAttributeDefinitionParams contains all the parameters to send to the API endpoint
for the list attribute definition operation typically these are written to a http.Request
*/
