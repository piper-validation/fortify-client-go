...
func (a *Client) ListCloudJobOfCloudPool(params *ListCloudJobOfCloudPoolParams, authInfo runtime.ClientAuthInfoWriter) (*ListCloudJobOfCloudPoolOK, error) {
	...
	if params == nil {
		params = NewListCloudJobOfCloudPoolParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listCloudJobOfCloudPool",
		Method:             "GET",
		PathPattern:        "/cloudpools/{parentId}/jobs",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListCloudJobOfCloudPoolReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListCloudJobOfCloudPoolOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listCloudJobOfCloudPool: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
