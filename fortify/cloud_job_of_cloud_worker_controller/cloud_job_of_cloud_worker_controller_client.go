...
func (a *Client) ListCloudJobOfCloudWorker(params *ListCloudJobOfCloudWorkerParams, authInfo runtime.ClientAuthInfoWriter) (*ListCloudJobOfCloudWorkerOK, error) {
	...
	if params == nil {
		params = NewListCloudJobOfCloudWorkerParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listCloudJobOfCloudWorker",
		Method:             "GET",
		PathPattern:        "/cloudworkers/{parentId}/cloudjobs",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListCloudJobOfCloudWorkerReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListCloudJobOfCloudWorkerOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listCloudJobOfCloudWorker: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
