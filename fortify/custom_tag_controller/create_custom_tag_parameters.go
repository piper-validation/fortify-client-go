...
// NewCreateCustomTagParams creates a new CreateCustomTagParams object
// with the default values initialized.
func NewCreateCustomTagParams() *CreateCustomTagParams {
	var ()
	return &CreateCustomTagParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewCreateCustomTagParamsWithTimeout creates a new CreateCustomTagParams object
...
// NewCreateCustomTagParamsWithContext creates a new CreateCustomTagParams object
...
// NewCreateCustomTagParamsWithHTTPClient creates a new CreateCustomTagParams object
...
/*CreateCustomTagParams contains all the parameters to send to the API endpoint
for the create custom tag operation typically these are written to a http.Request
*/
...
func (o *CreateCustomTagParams) WithContext(ctx context.Context) *CreateCustomTagParams {
	o.SetContext(ctx)
	return o
}
...
func (o *CreateCustomTagParams) WithData(data *models.CustomTag) *CreateCustomTagParams {
	o.SetData(data)
	return o
}
