...
// NewListCustomTagParams creates a new ListCustomTagParams object
...
// NewListCustomTagParamsWithTimeout creates a new ListCustomTagParams object
...
// NewListCustomTagParamsWithContext creates a new ListCustomTagParams object
...
// NewListCustomTagParamsWithHTTPClient creates a new ListCustomTagParams object
...
/*ListCustomTagParams contains all the parameters to send to the API endpoint
for the list custom tag operation typically these are written to a http.Request
*/
...
func (o *ListCustomTagParams) WithContext(ctx context.Context) *ListCustomTagParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ListCustomTagParams) WithQ(q *string) *ListCustomTagParams {
	o.SetQ(q)
	return o
}
