...
func (a *Client) ListGroupOfAuthEntity(params *ListGroupOfAuthEntityParams, authInfo runtime.ClientAuthInfoWriter) (*ListGroupOfAuthEntityOK, error) {
	...
	if params == nil {
		params = NewListGroupOfAuthEntityParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listGroupOfAuthEntity",
		Method:             "GET",
		PathPattern:        "/authEntities/{parentId}/groups",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListGroupOfAuthEntityReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListGroupOfAuthEntityOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listGroupOfAuthEntity: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
