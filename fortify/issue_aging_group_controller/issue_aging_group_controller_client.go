...
func (a *Client) ListIssueAgingGroup(params *ListIssueAgingGroupParams, authInfo runtime.ClientAuthInfoWriter) (*ListIssueAgingGroupOK, error) {
	...
	if params == nil {
		params = NewListIssueAgingGroupParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listIssueAgingGroup",
		Method:             "GET",
		PathPattern:        "/issueaginggroup",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListIssueAgingGroupReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListIssueAgingGroupOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listIssueAgingGroup: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
