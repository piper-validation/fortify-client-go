...
func (a *Client) GetIssueAgingPortlet(params *GetIssueAgingPortletParams, authInfo runtime.ClientAuthInfoWriter) (*GetIssueAgingPortletOK, error) {
	...
	if params == nil {
		params = NewGetIssueAgingPortletParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getIssueAgingPortlet",
		Method:             "GET",
		PathPattern:        "/portlets/issueaging",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetIssueAgingPortletReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetIssueAgingPortletOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getIssueAgingPortlet: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
