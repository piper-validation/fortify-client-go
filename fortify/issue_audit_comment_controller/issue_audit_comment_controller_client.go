...
func (a *Client) ListIssueAuditComment(params *ListIssueAuditCommentParams, authInfo runtime.ClientAuthInfoWriter) (*ListIssueAuditCommentOK, error) {
	...
	if params == nil {
		params = NewListIssueAuditCommentParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listIssueAuditComment",
		Method:             "GET",
		...
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListIssueAuditCommentReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListIssueAuditCommentOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listIssueAuditComment: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
