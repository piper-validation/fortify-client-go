...
// NewReadIssueParams creates a new ReadIssueParams object
// with the default values initialized.
func NewReadIssueParams() *ReadIssueParams {
	var ()
	return &ReadIssueParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewReadIssueParamsWithTimeout creates a new ReadIssueParams object
...
// NewReadIssueParamsWithContext creates a new ReadIssueParams object
...
// NewReadIssueParamsWithHTTPClient creates a new ReadIssueParams object
...
/*ReadIssueParams contains all the parameters to send to the API endpoint
for the read issue operation typically these are written to a http.Request
*/
