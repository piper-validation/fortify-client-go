...
// NewRefreshLdapObjectParams creates a new RefreshLdapObjectParams object
// with the default values initialized.
func NewRefreshLdapObjectParams() *RefreshLdapObjectParams {

	return &RefreshLdapObjectParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewRefreshLdapObjectParamsWithTimeout creates a new RefreshLdapObjectParams object
...
// NewRefreshLdapObjectParamsWithContext creates a new RefreshLdapObjectParams object
...
// NewRefreshLdapObjectParamsWithHTTPClient creates a new RefreshLdapObjectParams object
...
/*RefreshLdapObjectParams contains all the parameters to send to the API endpoint
for the refresh ldap object operation typically these are written to a http.Request
*/
