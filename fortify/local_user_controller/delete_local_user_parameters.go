...
// NewDeleteLocalUserParams creates a new DeleteLocalUserParams object
// with the default values initialized.
func NewDeleteLocalUserParams() *DeleteLocalUserParams {
	var ()
	return &DeleteLocalUserParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewDeleteLocalUserParamsWithTimeout creates a new DeleteLocalUserParams object
...
// NewDeleteLocalUserParamsWithContext creates a new DeleteLocalUserParams object
...
// NewDeleteLocalUserParamsWithHTTPClient creates a new DeleteLocalUserParams object
...
/*DeleteLocalUserParams contains all the parameters to send to the API endpoint
for the delete local user operation typically these are written to a http.Request
*/
...
func (o *DeleteLocalUserParams) WithContext(ctx context.Context) *DeleteLocalUserParams {
	o.SetContext(ctx)
	return o
}
...
func (o *DeleteLocalUserParams) WithID(id int64) *DeleteLocalUserParams {
	o.SetID(id)
	return o
}
