...
func (a *Client) GetParserPluginImage(params *GetParserPluginImageParams, authInfo runtime.ClientAuthInfoWriter) (*GetParserPluginImageOK, error) {
	...
	if params == nil {
		params = NewGetParserPluginImageParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getParserPluginImage",
		Method:             "GET",
		PathPattern:        "/pluginimage/parser",
		ProducesMediaTypes: []string{"image/png"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &GetParserPluginImageReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetParserPluginImageOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getParserPluginImage: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
