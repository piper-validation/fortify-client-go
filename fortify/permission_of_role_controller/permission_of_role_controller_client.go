...
func (a *Client) ListPermissionOfRole(params *ListPermissionOfRoleParams, authInfo runtime.ClientAuthInfoWriter) (*ListPermissionOfRoleOK, error) {
	...
	if params == nil {
		params = NewListPermissionOfRoleParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listPermissionOfRole",
		Method:             "GET",
		PathPattern:        "/roles/{parentId}/permissions",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListPermissionOfRoleReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListPermissionOfRoleOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listPermissionOfRole: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
