...
// NewTestProjectParams creates a new TestProjectParams object
...
// NewTestProjectParamsWithTimeout creates a new TestProjectParams object
...
// NewTestProjectParamsWithContext creates a new TestProjectParams object
...
// NewTestProjectParamsWithHTTPClient creates a new TestProjectParams object
...
/*TestProjectParams contains all the parameters to send to the API endpoint
for the test project operation typically these are written to a http.Request
*/
type TestProjectParams struct {

	/*Resource
	  resource

	*/
	Resource *models.ApplicationNameTestRequest
