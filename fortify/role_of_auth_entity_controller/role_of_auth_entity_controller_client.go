...
func (a *Client) ListRoleOfAuthEntity(params *ListRoleOfAuthEntityParams, authInfo runtime.ClientAuthInfoWriter) (*ListRoleOfAuthEntityOK, error) {
	...
	if params == nil {
		params = NewListRoleOfAuthEntityParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listRoleOfAuthEntity",
		Method:             "GET",
		PathPattern:        "/authEntities/{parentId}/roles",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListRoleOfAuthEntityReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListRoleOfAuthEntityOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listRoleOfAuthEntity: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
