...
func (a *Client) ListScanOfArtifact(params *ListScanOfArtifactParams, authInfo runtime.ClientAuthInfoWriter) (*ListScanOfArtifactOK, error) {
	...
	if params == nil {
		params = NewListScanOfArtifactParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listScanOfArtifact",
		Method:             "GET",
		PathPattern:        "/artifacts/{parentId}/scans",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &ListScanOfArtifactReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ListScanOfArtifactOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for listScanOfArtifact: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
