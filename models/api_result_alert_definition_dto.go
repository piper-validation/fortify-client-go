...
// APIResultAlertDefinitionDto Api result alert definition dto
// swagger:model ApiResult«AlertDefinitionDto»
...
func (m *APIResultAlertDefinitionDto) validateData(formats strfmt.Registry) error {
...
func (m *APIResultAlertDefinitionDto) UnmarshalBinary(b []byte) error {
	var res APIResultAlertDefinitionDto
