...
// APIResultApplicationState Api result application state
// swagger:model ApiResult«Application State»
...
func (m *APIResultApplicationState) validateData(formats strfmt.Registry) error {
...
func (m *APIResultApplicationState) UnmarshalBinary(b []byte) error {
	var res APIResultApplicationState
