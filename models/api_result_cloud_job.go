...
// APIResultCloudJob Api result cloud job
// swagger:model ApiResult«CloudJob»
...
func (m *APIResultCloudJob) validateData(formats strfmt.Registry) error {
