...
// APIResultCloudPool Api result cloud pool
// swagger:model ApiResult«CloudPool»
...
func (m *APIResultCloudPool) validateData(formats strfmt.Registry) error {
