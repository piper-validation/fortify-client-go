...
// APIResultCloudSystemMetrics Api result cloud system metrics
// swagger:model ApiResult«CloudSystemMetrics»
...
func (m *APIResultCloudSystemMetrics) validateData(formats strfmt.Registry) error {
...
func (m *APIResultCloudSystemMetrics) UnmarshalBinary(b []byte) error {
	var res APIResultCloudSystemMetrics
