...
// APIResultCloudSystemSettings Api result cloud system settings
// swagger:model ApiResult«CloudSystemSettings»
...
func (m *APIResultCloudSystemSettings) validateData(formats strfmt.Registry) error {
...
func (m *APIResultCloudSystemSettings) UnmarshalBinary(b []byte) error {
	var res APIResultCloudSystemSettings
