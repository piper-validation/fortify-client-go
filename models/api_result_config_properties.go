...
// APIResultConfigProperties Api result config properties
// swagger:model ApiResult«ConfigProperties»
...
func (m *APIResultConfigProperties) validateData(formats strfmt.Registry) error {
...
func (m *APIResultConfigProperties) UnmarshalBinary(b []byte) error {
	var res APIResultConfigProperties
