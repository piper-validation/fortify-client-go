...
// APIResultConfigProperty Api result config property
// swagger:model ApiResult«ConfigProperty»
...
func (m *APIResultConfigProperty) validateData(formats strfmt.Registry) error {
...
func (m *APIResultConfigProperty) UnmarshalBinary(b []byte) error {
	var res APIResultConfigProperty
