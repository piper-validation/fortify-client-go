...
// APIResultCustomTag Api result custom tag
// swagger:model ApiResult«Custom tag»
...
func (m *APIResultCustomTag) validateData(formats strfmt.Registry) error {
