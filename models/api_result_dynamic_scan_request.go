...
// APIResultDynamicScanRequest Api result dynamic scan request
// swagger:model ApiResult«DynamicScanRequest»
...
func (m *APIResultDynamicScanRequest) validateData(formats strfmt.Registry) error {
...
func (m *APIResultDynamicScanRequest) UnmarshalBinary(b []byte) error {
	var res APIResultDynamicScanRequest
