...
// APIResultFeature Api result feature
// swagger:model ApiResult«Feature»
...
func (m *APIResultFeature) validateData(formats strfmt.Registry) error {
