...
// APIResultIIDMigration Api result i ID migration
// swagger:model ApiResult«IID Migration»
...
func (m *APIResultIIDMigration) validateData(formats strfmt.Registry) error {
