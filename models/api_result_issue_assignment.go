...
// APIResultIssueAssignment Api result issue assignment
// swagger:model ApiResult«Issue Assignment»
...
func (m *APIResultIssueAssignment) validateData(formats strfmt.Registry) error {
...
func (m *APIResultIssueAssignment) UnmarshalBinary(b []byte) error {
	var res APIResultIssueAssignment
