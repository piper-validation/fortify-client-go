...
// APIResultIssueAttachment Api result issue attachment
// swagger:model ApiResult«Issue Attachment»
...
func (m *APIResultIssueAttachment) validateData(formats strfmt.Registry) error {
...
func (m *APIResultIssueAttachment) UnmarshalBinary(b []byte) error {
	var res APIResultIssueAttachment
