...
// APIResultIssueTemplate Api result issue template
// swagger:model ApiResult«Issue Template»
...
func (m *APIResultIssueTemplate) validateData(formats strfmt.Registry) error {
...
func (m *APIResultIssueTemplate) UnmarshalBinary(b []byte) error {
	var res APIResultIssueTemplate
