...
// APIResultIssueViewTemplate Api result issue view template
// swagger:model ApiResult«IssueViewTemplate»
...
func (m *APIResultIssueViewTemplate) validateData(formats strfmt.Registry) error {
...
func (m *APIResultIssueViewTemplate) UnmarshalBinary(b []byte) error {
	var res APIResultIssueViewTemplate
