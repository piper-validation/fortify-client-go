...
// APIResultLDAPEntity Api result l d a p entity
// swagger:model ApiResult«LDAP entity»
...
func (m *APIResultLDAPEntity) validateData(formats strfmt.Registry) error {
