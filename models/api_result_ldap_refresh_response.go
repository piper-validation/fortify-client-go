...
// APIResultLdapRefreshResponse Api result ldap refresh response
// swagger:model ApiResult«LdapRefreshResponse»
...
func (m *APIResultLdapRefreshResponse) validateData(formats strfmt.Registry) error {
...
func (m *APIResultLdapRefreshResponse) UnmarshalBinary(b []byte) error {
	var res APIResultLdapRefreshResponse
