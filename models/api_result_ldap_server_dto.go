...
// APIResultLdapServerDto Api result ldap server dto
// swagger:model ApiResult«LdapServerDto»
...
func (m *APIResultLdapServerDto) validateData(formats strfmt.Registry) error {
...
func (m *APIResultLdapServerDto) UnmarshalBinary(b []byte) error {
	var res APIResultLdapServerDto
