...
// APIResultLicense Api result license
// swagger:model ApiResult«License»
...
func (m *APIResultLicense) validateData(formats strfmt.Registry) error {
