...
// APIResultListAATrainingStatus Api result list a a training status
// swagger:model ApiResult«List«AATrainingStatus»»
...
func (m *APIResultListAATrainingStatus) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListAATrainingStatus) UnmarshalBinary(b []byte) error {
	var res APIResultListAATrainingStatus
