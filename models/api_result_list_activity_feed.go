...
// APIResultListActivityFeed Api result list activity feed
// swagger:model ApiResult«List«Activity Feed»»
...
func (m *APIResultListActivityFeed) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListActivityFeed) UnmarshalBinary(b []byte) error {
	var res APIResultListActivityFeed
