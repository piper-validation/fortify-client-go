...
// APIResultListAlertHistoryEntry Api result list alert history entry
// swagger:model ApiResult«List«Alert History Entry»»
...
func (m *APIResultListAlertHistoryEntry) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListAlertHistoryEntry) UnmarshalBinary(b []byte) error {
	var res APIResultListAlertHistoryEntry
