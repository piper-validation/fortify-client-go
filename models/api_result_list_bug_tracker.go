...
// APIResultListBugTracker Api result list bug tracker
// swagger:model ApiResult«List«Bug Tracker»»
...
func (m *APIResultListBugTracker) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListBugTracker) UnmarshalBinary(b []byte) error {
	var res APIResultListBugTracker
