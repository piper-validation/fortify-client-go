...
// APIResultListBulkResponseItem Api result list bulk response item
// swagger:model ApiResult«List«Bulk Response Item»»
...
func (m *APIResultListBulkResponseItem) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListBulkResponseItem) UnmarshalBinary(b []byte) error {
	var res APIResultListBulkResponseItem
