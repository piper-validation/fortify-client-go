...
// APIResultListCloudJob Api result list cloud job
// swagger:model ApiResult«List«CloudJob»»
...
func (m *APIResultListCloudJob) validateData(formats strfmt.Registry) error {
