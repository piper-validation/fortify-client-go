...
// APIResultListCloudPool Api result list cloud pool
// swagger:model ApiResult«List«CloudPool»»
...
func (m *APIResultListCloudPool) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListCloudPool) UnmarshalBinary(b []byte) error {
	var res APIResultListCloudPool
