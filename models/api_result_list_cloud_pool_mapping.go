...
// APIResultListCloudPoolMapping Api result list cloud pool mapping
// swagger:model ApiResult«List«CloudPoolMapping»»
...
func (m *APIResultListCloudPoolMapping) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListCloudPoolMapping) UnmarshalBinary(b []byte) error {
	var res APIResultListCloudPoolMapping
