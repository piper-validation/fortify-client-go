...
// APIResultListCloudWorker Api result list cloud worker
// swagger:model ApiResult«List«CloudWorker»»
...
func (m *APIResultListCloudWorker) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListCloudWorker) UnmarshalBinary(b []byte) error {
	var res APIResultListCloudWorker
