...
// APIResultListCustomTag Api result list custom tag
// swagger:model ApiResult«List«Custom tag»»
...
func (m *APIResultListCustomTag) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListCustomTag) UnmarshalBinary(b []byte) error {
	var res APIResultListCustomTag
