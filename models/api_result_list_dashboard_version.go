...
// APIResultListDashboardVersion Api result list dashboard version
// swagger:model ApiResult«List«Dashboard Version»»
...
func (m *APIResultListDashboardVersion) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListDashboardVersion) UnmarshalBinary(b []byte) error {
	var res APIResultListDashboardVersion
