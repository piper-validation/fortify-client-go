...
// APIResultListDataExport Api result list data export
// swagger:model ApiResult«List«Data Export»»
...
func (m *APIResultListDataExport) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListDataExport) UnmarshalBinary(b []byte) error {
	var res APIResultListDataExport
