...
// APIResultListEngineType Api result list engine type
// swagger:model ApiResult«List«Engine type»»
...
func (m *APIResultListEngineType) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListEngineType) UnmarshalBinary(b []byte) error {
	var res APIResultListEngineType
