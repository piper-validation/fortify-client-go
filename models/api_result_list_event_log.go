...
// APIResultListEventLog Api result list event log
// swagger:model ApiResult«List«EventLog»»
...
func (m *APIResultListEventLog) validateData(formats strfmt.Registry) error {
