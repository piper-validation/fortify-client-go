...
// APIResultListFeature Api result list feature
// swagger:model ApiResult«List«Feature»»
...
func (m *APIResultListFeature) validateData(formats strfmt.Registry) error {
