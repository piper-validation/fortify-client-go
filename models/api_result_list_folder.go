...
// APIResultListFolder Api result list folder
// swagger:model ApiResult«List«Folder»»
...
func (m *APIResultListFolder) validateData(formats strfmt.Registry) error {
