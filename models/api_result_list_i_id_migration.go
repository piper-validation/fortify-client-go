...
// APIResultListIIDMigration Api result list i ID migration
// swagger:model ApiResult«List«IID Migration»»
...
func (m *APIResultListIIDMigration) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListIIDMigration) UnmarshalBinary(b []byte) error {
	var res APIResultListIIDMigration
