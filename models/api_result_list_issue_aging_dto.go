...
// APIResultListIssueAgingDto Api result list issue aging dto
// swagger:model ApiResult«List«IssueAgingDto»»
...
func (m *APIResultListIssueAgingDto) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListIssueAgingDto) UnmarshalBinary(b []byte) error {
	var res APIResultListIssueAgingDto
