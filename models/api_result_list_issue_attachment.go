...
// APIResultListIssueAttachment Api result list issue attachment
// swagger:model ApiResult«List«Issue Attachment»»
...
func (m *APIResultListIssueAttachment) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListIssueAttachment) UnmarshalBinary(b []byte) error {
	var res APIResultListIssueAttachment
