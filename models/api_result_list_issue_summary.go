...
// APIResultListIssueSummary Api result list issue summary
// swagger:model ApiResult«List«Issue Summary»»
...
func (m *APIResultListIssueSummary) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListIssueSummary) UnmarshalBinary(b []byte) error {
	var res APIResultListIssueSummary
