...
// APIResultListIssueTemplate Api result list issue template
// swagger:model ApiResult«List«Issue Template»»
...
func (m *APIResultListIssueTemplate) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListIssueTemplate) UnmarshalBinary(b []byte) error {
	var res APIResultListIssueTemplate
