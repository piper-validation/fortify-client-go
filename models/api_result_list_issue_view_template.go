...
// APIResultListIssueViewTemplate Api result list issue view template
// swagger:model ApiResult«List«IssueViewTemplate»»
...
func (m *APIResultListIssueViewTemplate) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListIssueViewTemplate) UnmarshalBinary(b []byte) error {
	var res APIResultListIssueViewTemplate
