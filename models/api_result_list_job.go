...
// APIResultListJob Api result list job
// swagger:model ApiResult«List«Job»»
...
func (m *APIResultListJob) validateData(formats strfmt.Registry) error {
