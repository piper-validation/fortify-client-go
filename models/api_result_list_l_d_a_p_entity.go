...
// APIResultListLDAPEntity Api result list l d a p entity
// swagger:model ApiResult«List«LDAP entity»»
...
func (m *APIResultListLDAPEntity) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListLDAPEntity) UnmarshalBinary(b []byte) error {
	var res APIResultListLDAPEntity
