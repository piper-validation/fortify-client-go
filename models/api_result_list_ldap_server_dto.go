...
// APIResultListLdapServerDto Api result list ldap server dto
// swagger:model ApiResult«List«LdapServerDto»»
...
func (m *APIResultListLdapServerDto) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListLdapServerDto) UnmarshalBinary(b []byte) error {
	var res APIResultListLdapServerDto
