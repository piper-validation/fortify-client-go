...
// APIResultListLocalUser Api result list local user
// swagger:model ApiResult«List«Local User»»
...
func (m *APIResultListLocalUser) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListLocalUser) UnmarshalBinary(b []byte) error {
	var res APIResultListLocalUser
