...
// APIResultListPermission Api result list permission
// swagger:model ApiResult«List«Permission»»
...
func (m *APIResultListPermission) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListPermission) UnmarshalBinary(b []byte) error {
	var res APIResultListPermission
