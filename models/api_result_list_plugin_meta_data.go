...
// APIResultListPluginMetaData Api result list plugin meta data
// swagger:model ApiResult«List«Plugin Meta Data»»
...
func (m *APIResultListPluginMetaData) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListPluginMetaData) UnmarshalBinary(b []byte) error {
	var res APIResultListPluginMetaData
