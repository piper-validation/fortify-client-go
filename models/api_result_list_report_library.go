...
// APIResultListReportLibrary Api result list report library
// swagger:model ApiResult«List«Report Library»»
...
func (m *APIResultListReportLibrary) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListReportLibrary) UnmarshalBinary(b []byte) error {
	var res APIResultListReportLibrary
