...
// APIResultListRole Api result list role
// swagger:model ApiResult«List«Role»»
...
func (m *APIResultListRole) validateData(formats strfmt.Registry) error {
