...
// APIResultListRulepackStatus Api result list rulepack status
// swagger:model ApiResult«List«RulepackStatus»»
...
func (m *APIResultListRulepackStatus) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListRulepackStatus) UnmarshalBinary(b []byte) error {
	var res APIResultListRulepackStatus
