...
// APIResultListScan Api result list scan
// swagger:model ApiResult«List«Scan»»
...
func (m *APIResultListScan) validateData(formats strfmt.Registry) error {
