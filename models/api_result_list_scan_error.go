...
// APIResultListScanError Api result list scan error
// swagger:model ApiResult«List«scan error»»
...
func (m *APIResultListScanError) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListScanError) UnmarshalBinary(b []byte) error {
	var res APIResultListScanError
