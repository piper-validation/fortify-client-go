...
// APIResultListSourceFileDto Api result list source file dto
// swagger:model ApiResult«List«SourceFileDto»»
...
func (m *APIResultListSourceFileDto) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListSourceFileDto) UnmarshalBinary(b []byte) error {
	var res APIResultListSourceFileDto
