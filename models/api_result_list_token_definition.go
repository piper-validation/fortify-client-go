...
// APIResultListTokenDefinition Api result list token definition
// swagger:model ApiResult«List«Token Definition»»
...
func (m *APIResultListTokenDefinition) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListTokenDefinition) UnmarshalBinary(b []byte) error {
	var res APIResultListTokenDefinition
