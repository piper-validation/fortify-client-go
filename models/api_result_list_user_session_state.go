...
// APIResultListUserSessionState Api result list user session state
// swagger:model ApiResult«List«UserSessionState»»
...
func (m *APIResultListUserSessionState) validateData(formats strfmt.Registry) error {
...
func (m *APIResultListUserSessionState) UnmarshalBinary(b []byte) error {
	var res APIResultListUserSessionState
