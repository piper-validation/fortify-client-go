...
// APIResultListVariable Api result list variable
// swagger:model ApiResult«List«Variable»»
...
func (m *APIResultListVariable) validateData(formats strfmt.Registry) error {
