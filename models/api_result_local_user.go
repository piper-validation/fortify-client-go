...
// APIResultLocalUser Api result local user
// swagger:model ApiResult«Local User»
...
func (m *APIResultLocalUser) validateData(formats strfmt.Registry) error {
