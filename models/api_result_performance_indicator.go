...
// APIResultPerformanceIndicator Api result performance indicator
// swagger:model ApiResult«PerformanceIndicator»
...
func (m *APIResultPerformanceIndicator) validateData(formats strfmt.Registry) error {
...
func (m *APIResultPerformanceIndicator) UnmarshalBinary(b []byte) error {
	var res APIResultPerformanceIndicator
