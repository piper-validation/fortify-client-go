...
// APIResultPermission Api result permission
// swagger:model ApiResult«Permission»
...
func (m *APIResultPermission) validateData(formats strfmt.Registry) error {
