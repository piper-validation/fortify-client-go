...
// APIResultPluginMetaData Api result plugin meta data
// swagger:model ApiResult«Plugin Meta Data»
...
func (m *APIResultPluginMetaData) validateData(formats strfmt.Registry) error {
...
func (m *APIResultPluginMetaData) UnmarshalBinary(b []byte) error {
	var res APIResultPluginMetaData
