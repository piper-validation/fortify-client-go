...
// APIResultReportDefinition Api result report definition
// swagger:model ApiResult«Report Definition»
...
func (m *APIResultReportDefinition) validateData(formats strfmt.Registry) error {
...
func (m *APIResultReportDefinition) UnmarshalBinary(b []byte) error {
	var res APIResultReportDefinition
