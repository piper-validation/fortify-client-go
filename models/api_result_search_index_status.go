...
// APIResultSearchIndexStatus Api result search index status
// swagger:model ApiResult«SearchIndexStatus»
...
func (m *APIResultSearchIndexStatus) validateData(formats strfmt.Registry) error {
...
func (m *APIResultSearchIndexStatus) UnmarshalBinary(b []byte) error {
	var res APIResultSearchIndexStatus
