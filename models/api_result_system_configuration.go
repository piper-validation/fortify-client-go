...
// APIResultSystemConfiguration Api result system configuration
// swagger:model ApiResult«System Configuration»
...
func (m *APIResultSystemConfiguration) validateData(formats strfmt.Registry) error {
...
func (m *APIResultSystemConfiguration) UnmarshalBinary(b []byte) error {
	var res APIResultSystemConfiguration
