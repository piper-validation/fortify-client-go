...
// APIResultUserPreferences Api result user preferences
// swagger:model ApiResult«User preferences»
...
func (m *APIResultUserPreferences) validateData(formats strfmt.Registry) error {
...
func (m *APIResultUserPreferences) UnmarshalBinary(b []byte) error {
	var res APIResultUserPreferences
