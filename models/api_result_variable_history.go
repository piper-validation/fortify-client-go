...
// APIResultVariableHistory Api result variable history
// swagger:model ApiResult«Variable History»
...
func (m *APIResultVariableHistory) validateData(formats strfmt.Registry) error {
...
func (m *APIResultVariableHistory) UnmarshalBinary(b []byte) error {
	var res APIResultVariableHistory
