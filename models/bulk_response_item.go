...
// BulkResponseItem bulk response item
// swagger:model Bulk Response Item
...
func (m *BulkResponseItem) validateRequest(formats strfmt.Registry) error {
...
func (m *BulkResponseItem) validateResponses(formats strfmt.Registry) error {
