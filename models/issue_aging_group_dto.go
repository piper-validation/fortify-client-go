...
// IssueAgingGroupDto Issue aging group object contains definition of application version attribute that can be used for issue aging table grouping.
// swagger:model IssueAgingGroupDto
...
func (m *IssueAgingGroupDto) validateID(formats strfmt.Registry) error {
...
func (m *IssueAgingGroupDto) validateName(formats strfmt.Registry) error {
