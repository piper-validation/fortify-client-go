...
// LdapRefreshResponse Result of refreshing ldap server
// swagger:model LdapRefreshResponse
...
func (m *LdapRefreshResponse) validateData(formats strfmt.Registry) error {
